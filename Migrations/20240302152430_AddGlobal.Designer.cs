...
namespace InteractiveTyingGameBlazor.Migrations
{
    ...
    [Migration("20240302152430_AddGlobal")]
    partial class AddGlobal
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InteractiveTyingGameBlazor.Models.TypingResult", b =>
                {
                    ...
                    b.OwnsMany("InteractiveTyingGameBlazor.Models.MissTypedChar", "MissTypedChars", b1 =>
                        {
                            b1.Property<Guid>("TypingResultId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("TypingResultId", "MissTypedCharId");

                            b1.ToTable("MissTypedChar");

                            b1.WithOwner()
                                .HasForeignKey("TypingResultId");
                        });

                    b.Navigation("MissTypedChars");
