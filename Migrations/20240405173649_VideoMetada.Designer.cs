...
namespace InteractiveTyingGameBlazor.Migrations
{
    ...
    [Migration("20240405173649_VideoMetada")]
    partial class VideoMetada
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InteractiveTyingGameBlazor.DbModels.TypingResult", b =>
                {
                    ...
                    b.HasOne("InteractiveTyingGameBlazor.DbModels.RegisteredVideo", "Video")
                        .WithMany()
